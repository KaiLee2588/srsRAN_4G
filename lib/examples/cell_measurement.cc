...
cell_search_cfg_t cell_detect_config = {SRSLTE_DEFAULT_MAX_FRAMES_PBCH,
          ...
          switch (state) {
            ...
            case MEASURE:
              ...
              if (srslte_ue_sync_get_sfidx(&ue_sync) == 5) {
                ...
                rssi = SRSLTE_VEC_EMA(
                    srslte_vec_avg_power_cf(sf_buffer[0], SRSLTE_SF_LEN(srslte_symbol_sz(cell.nof_prb))), rssi, 0.05);
